...
public class BrowserEngine {
	...
	public static int waitfortime = 3;
	...
	public WebDriver getBrowser() {
		...
		if (browserName.equalsIgnoreCase("Firefox")) {
			...
			Logger.Output(LogType.LogTypeName.INFO, "Maximize Chrome browser...");
		} else if (browserName.equalsIgnoreCase("IE")) {
			System.setProperty("webdriver.ie.driver", ".\\Tools\\IEDriverServer.exe");
			driver = new InternetExplorerDriver();
			Logger.Output(LogType.LogTypeName.INFO, "Launching IE ...");
			driver.manage().window().maximize();
			Logger.Output(LogType.LogTypeName.INFO, "Maximize IE browser...");
		}

		driver.get(serverURL);
		Logger.Output(LogType.LogTypeName.INFO, "Open URL: " + serverURL);
		Logger.Output(LogType.LogTypeName.INFO, "Please confirm URL: " + driver.getCurrentUrl());
		driver.manage().window().maximize();
	 ...
	 * 线层等待
	 */
	public void ThreadWait(int sleeptime) {
		...
		Logger.Output(LogType.LogTypeName.INFO, "Sleep Wait for " + sleeptime + " millseconds.");
	}
